                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="qr_margin" value="{{ old('qr_margin', 0) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="qr_background_transparent"
                                                    value="{{ old('qr_background_transparent', 0) }}" min="0" max="100"
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="color" name="qr_eye_color_inner_0"
                                                    value="{{ old('qr_eye_color_inner_0', '#000000') }}"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="color" name="qr_eye_color_outer_0"
                                                    value="{{ old('qr_eye_color_outer_0', '#000000') }}"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="color" name="qr_eye_color_inner_1"
                                                    value="{{ old('qr_eye_color_inner_1', '#000000') }}"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="color" name="qr_eye_color_outer_1"
                                                    value="{{ old('qr_eye_color_outer_1', '#000000') }}"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="color" name="qr_eye_color_inner_2"
                                                    value="{{ old('qr_eye_color_inner_2', '#000000') }}"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="color" name="qr_eye_color_outer_2"
                                                    value="{{ old('qr_eye_color_outer_2', '#000000') }}"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="color" name="qr_gradient_start"
                                                    value="{{ old('qr_gradient_start', '#000000') }}"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="color" name="qr_gradient_end"
                                                    value="{{ old('qr_gradient_end', '#000000') }}"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-4">
                            ...
                            <div class="col-4">
                                @if (session('code'))
                                    @if (pathinfo(session('code'))['extension'] === 'eps')
                                        QR Code available, <a href="{{ asset('qr_code/' . session('code')) }}">click
                                            here</a> to download it.
                                    @else
                                        <img src="{{ asset('qr_code/' . session('code')) }}"
                                            alt="{{ session('code') }}" class="img-fluid">
                                    @endif
                                @endif
                            </div>
                        </div>
